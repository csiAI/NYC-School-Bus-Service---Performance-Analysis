...
I have performed Data Cleaning and Exploratory Data Analysis using SQL. I then created a dashboard in Tableau. The SQL file with the code can be found [here]([UpSELECT * FROM nyc_bus_service.nyc_bus_service;
